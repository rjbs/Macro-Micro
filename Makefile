# This Makefile is for the Macro::Expander extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Macro/Expander.pm]
...
FULLEXT = Macro/Expander
BASEEXT = Expander
PARENT_NAME = Macro
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Macro/Expander.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Macro/Expander.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Macro
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Macro
...
TO_INST_PM = lib/Macro/Expander.pm

PM_TO_BLIB = lib/Macro/Expander.pm \
	blib/lib/Macro/Expander.pm
...
DISTNAME = Macro-Expander
DISTVNAME = Macro-Expander-0.01
...
manifypods : pure_all  \
	lib/Macro/Expander.pm \
	lib/Macro/Expander.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Macro/Expander.pm $(INST_MAN3DIR)/Macro::Expander.$(MAN3EXT) 
...
clean :: clean_subdirs
	-$(RM_RF) Macro-Expander-* cover_db ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all $(INST_ARCHAUTODIR)/extralibs.ld perlmain.c tmon.out mon.out so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe perl perl$(EXE_EXT) $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def lib$(BASEEXT).def $(BASEEXT).exp $(BASEEXT).x core core.*perl.*.? *perl.core core.[0-9] core.[0-9][0-9] core.[0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9][0-9]
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Macro/Expander.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Macro-Expander' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Macro/Expander.pm blib/lib/Macro/Expander.pm 
	$(NOECHO) $(TOUCH) $@
